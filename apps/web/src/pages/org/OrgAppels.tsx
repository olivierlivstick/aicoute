...
export function OrgAppelsPage() {
  ...
  useEffect(() => {
    supabase
      .from('calls')
      .select('id, status, scheduled_at, started_at, duration_seconds, engine, fluidity_metrics, recording_analysis, tuning_snapshot, recording_path, beneficiaries(first_name, last_name)')
