...
export function formatDate(date: string | Date, options?: Intl.DateTimeFormatOptions, locale = 'fr-FR') {
  return new Intl.DateTimeFormat(locale, options ?? { dateStyle: 'long' }).format(new Date(date))
}
